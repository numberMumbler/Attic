...
run_tests! {
    ...
    help_me_unpack_1: (
        ...
        r#"{"int":-1972501102,"uint":4190318201,"short":27553,"float":91.06981658935547,"double":362.2959514402903,"big_endian_double":362.2959514402903}"#.to_string(),
    ),
    help_me_unpack_2: (
        r#"{"bytes":"q7jhjOYeqs/4lQAA+ypqQ1owWBeoOFVAQFU4qBdYMFo="}"#.to_string(),
        r#"{"int":-1931364181,"uint":3484032742,"short":-27144,"float":234.16789245605469,"double":84.88525947200961,"big_endian_double":84.88525947200961}"#.to_string(),
    ),
}
